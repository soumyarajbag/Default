    ...
    <>
      <div>
        ...
        <div className="flex flex-col justify-evenly items-center">
          <h1 className=" min-[280px]:text-base min-[360px]:text-2xl  md:text-4xl font-bold text-center min-[360px]:mb-4 text-white absolute top-[12vh] lg:top-[20vh] xl:top-[12vh]">
            Predict Stock Price for Any Company Now !
          </h1>
          <div className=" w-full  flex flex-row justify-center mt-16 items-center content-center text-center z-10 absolute top-[15vh] lg:top-[22vh] xl:top-[15vh] m-auto">
            <input
              type="text"
        ...
        <div className="flex flex-col 2xl:flex-row  justify-center items-center gap-8 md:gap-14 min-[900px]:gap-20 2xl:gap-9 xl:space-x-10 absolute 2xl:top-[35vh] 2xl:px-[16vh] min-[280px]:top-[35vh] min-[360px]:top-[32vh] min-[360px]:px-[0.90rem] min-[390px]:px-[1.5vh]  min-[400px]:px-[1vh] md:px-7 min-[900px]:top-[28vh] lg:top-[48vh]  min-[1080px]:px-12">
