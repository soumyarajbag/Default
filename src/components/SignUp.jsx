...
const SignUp = ({setSign}) => {
  ...
  return (
    ...
    >
      <div
        className="bg-black bg-opacity-80 2xl:bg-inherit flex flex-col text-white border-4 border-blue-400 rounded-xl p-2  2xl:w-[400px] min-[360px]:w-[330px] min-[400px]:w-[360px] min-[500px]:w-[400px] min-[800px]:w-[500px] min-[900px]:w-[600px] lg:w-[400px] min-[1080px]:w-[700px] xl:w-[500px] 2xl:h-[700px] min-[360px]:h-[560px] min-[390px]:h-[580px] min-[400px]:h-[600px] min-[500px]:h-[580px] min-[600px]:h-[640px] min-[700px]:h-[720px] min-[800px]:h-[770px] min-[900px]:h-[820px] lg:h-[450px] min-[1080px]:h-[900px] xl:h-[620px]" >
